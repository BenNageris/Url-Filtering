...
function new_check_body() {
    ...
    alert("avg = " + avg);
    alert("max = " + neg_score_min);
    alert("percent = " + (parseFloat(neg_scores_count) / scores.length));
    ...
    if (avg > 0) {
        if (pos_score_max > 4)
            return true;
        if ((parseFloat(pos_scores_count) / scores.length) > 0.5)
            return true;
    }

    if (avg < 0 && neg_score_min > -5) {
        if (neg_score_min >= -2)
            return true;
        if ((parseFloat(neg_scores_count) / scores.length) < 0.4)
            return true;
    }
